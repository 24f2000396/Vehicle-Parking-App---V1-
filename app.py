...
def create_admin():
    ...
    if not if_exists:
        admin = User(email = 'piyush@gmail.com',password = '6299087198', name = 'piyush singh', 
                      address = 'surat', pin_code = '394210', is_admin = True)
...
def admin_summary():
    ...
    for lot in parking_lots:
        ...
        total_income = sum(h.total_price for h in histories)
